				...
				<div class="flex items-center p-4 border-b border-neutral-200 justify-between w-full">
					...
					<div class="relative inline-block text-left z-100 ml-4">
						...
						<button
							...
							class="ml-4 w-full md:w-auto flex items-center justify-center py-2 px-4 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-500 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-blue-400 dark:hover:bg-gray-700"
						>
						...
						<!-- Dropdown menu for gender filter -->
						<div v-show="filterdropdownOpen" id="filterDropdown" class="absolute z-[100] w-48 mt-2 bg-white rounded-lg shadow-lg dark:bg-gray-700 p-3">
							...
							<ul class="space-y-2 text-sm">
								<li class="flex items-center">
									...
									/>
									<label for="male" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">
										Male
									</label>
								</li>
								<li class="flex items-center">
									<input
										...
										class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
									/>
									<label for="female" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">
										Female
									</label>
								</li>
								<li class="flex items-center">
									<input
										...
										class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
									/>
									<label for="other" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">
										Other
									</label>
								</li>
							</ul>
