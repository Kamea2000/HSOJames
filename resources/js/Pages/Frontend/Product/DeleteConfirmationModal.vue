<template>
  <div v-if="isOpen" class="fixed top-0 left-0 w-full h-full flex items-center justify-center z-50">
    ...
    <div class="relative max-w-md max-h-full w-full bg-white shadow dark:bg-gray-800">
      <!-- Modal header -->
      <div class="flex justify-between items-center px-4 py-2 bg-red-00 border-b dark:bg-gray-700">
      ...
      <div class="p-4 text-left">
        ...
        <p class="text-gray-700 dark:text-gray-300 mb-4">
          Are you sure you want to delete this item: <strong>{{ productName }}</strong>?
        </p>
